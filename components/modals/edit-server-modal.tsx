...
function EditServerModal() {
  ...
  useEffect(() => {
    if (server) {
      ...
      form.setValue("imageUrl", `/uploads/${server.image}`);
    }
  }, [form, server, isModalOpen]);

  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    // Todo: Consertar quando dá enter no input text a imagem some do input file
    ...
    try {
      ...
      formData.append("serverName", values.name);
